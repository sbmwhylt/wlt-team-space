...
router.post("/contact", async (req, res) => {
  try {
    ...
    // Check if formData is an object (structured data) or string
    const isStructuredData = formData && typeof formData === "object";

    // Generate different HTML based on data type
    let contentHtml;

    if (isStructuredData) {
      // Create clean rows for each field
      ...
      // Use message or formData as plain text
